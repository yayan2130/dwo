...
$sql = "SELECT concat('name:',date_format(t.tanggallengkap, '%Y')) as name, concat('y:', sum(fp.amount)) as y, concat('drilldown:', date_format(t.tanggallengkap, '%Y')) as drilldown
        FROM time t
...
$sql = "SELECT date_format(t.tanggallengkap, '%Y') tahun, sum(fp.amount) as tot_kat
...
$sql = "SELECT date_format(t.tanggallengkap, '%Y') tahun, date_format(t.tanggallengkap, '%M') as bulan, sum(fp.amount) as pendapatan_kat
        FROM fakta_pendapatan fp 
        JOIN time t ON (t.time_id = fp.time_id)
...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Chart - Made from High   Chart</title>
    ...
    <body>
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Chart 2</a></li>
                                </ol>
                            </div>
        ...
        Highcharts.chart('container', {
            ...
            tooltip: {
                ...
                pointFormat: '<span style="color:{point.color}">{point.name}</span>: <br>{point.y:.0f} USD</b> of total<br/>'
            },

            series: [{
                name: "pendapatan berdasarkan Tahun",
                colorByPoint: false,
                data: <?php
